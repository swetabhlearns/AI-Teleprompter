...
var CANONICAL_ROADMAP_SECTIONS = ["Hook", "Core Narrative", "Call to Action", "Finish"];
...
function SectionBlock({ section, notationPreferences }) {
  return /* @__PURE__ */ jsxs("section", { className: "teleprompter-section", children: [
    notationPreferences.showSections && CANONICAL_ROADMAP_SECTIONS.includes(section.title) && /* @__PURE__ */ jsxs("div", { className: "teleprompter-section-label", children: [
    ...
    section.paragraphs.map((paragraph) => /* @__PURE__ */ jsxs(
      "p",
      {
        ...
        children: [
          isTempoVisible(paragraph.tempo, notationPreferences) && /* @__PURE__ */ jsx("span", { className: `teleprompter-tempo-badge tempo-${paragraph.tempo}`, children: paragraph.tempo === "slow" ? "Slow" : "Fast" }),
...
function Teleprompter({
  ...
  const canonicalSections = useMemo(() => {
    ...
    return parsedScript.sections.filter((section) => sectionOrder.has(section.title)).slice().sort((left, right) => sectionOrder.get(left.title) - sectionOrder.get(right.title));
  ...
  const setPause = useCallback((nextPaused) => {
    if (typeof controlledPaused === "boolean") {
  ...
  if (!script) {
    return /* @__PURE__ */ jsx("div", { className: variant === "panel" ? "teleprompter-panel" : "teleprompter-overlay", children: /* @__PURE__ */ jsxs("div", { className: "teleprompter-empty", children: [
  ...
  const rootClassName = variant === "panel" ? "teleprompter-panel glass-strong" : "teleprompter-overlay";
  const textClassName = variant === "panel" ? "teleprompter-text teleprompter-panel-text" : "teleprompter-text";
  const controlsClassName = variant === "panel" ? "teleprompter-controls teleprompter-controls-panel" : "teleprompter-controls";
  const liveIndicatorClassName = variant === "panel" ? "teleprompter-live-indicator teleprompter-live-indicator-panel" : "teleprompter-live-indicator";
  return /* @__PURE__ */ jsxs("div", { className: rootClassName, children: [
    ...
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        style: {
          ...
          minHeight: variant === "panel" ? 0 : void 0,
          flex: variant === "panel" ? "1 1 0" : void 0,
          overflow: "hidden",
          overflowY: variant === "panel" ? "auto" : "hidden",
          paddingTop: variant === "panel" ? "0" : "44vh",
          paddingBottom: variant === "panel" ? "0" : "42vh"
        },
        children: canonicalSections.length === 0 ? /* @__PURE__ */ jsx("p", { className: "teleprompter-paragraph", children: "Add a section header to shape the flow." }) : canonicalSections.map((section, index) => /* @__PURE__ */ jsx(
          SectionBlock,
          {
    ...
    !resolvedPreferences.distractionFree && showControls && /* @__PURE__ */ jsxs(Fragment, { children: [
      isActive && /* @__PURE__ */ jsxs("div", { className: controlsClassName, children: [
      ...
      isActive && showHints && /* @__PURE__ */ jsx("div", { className: "teleprompter-hints", children: "\u2191\u2193 Speed \u2022 Space Pause \u2022 R Reset" })
    ] }),
    isActive && showLiveIndicator && /* @__PURE__ */ jsx("div", { className: liveIndicatorClassName, children: /* @__PURE__ */ jsx("span", { className: isSpeaking ? "speaking" : "silent", children: isSpeaking ? "Speaking" : `Tracking ${Math.min(audioLevel * 2, 100)}%` }) })
  ] });
}

  ...
  return /* @__PURE__ */ jsxs("div", { className: rootClassName, children: [
    ...
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        style: {
          height: variant === "panel" ? "100%" : "100%",
          minHeight: variant === "panel" ? 0 : void 0,
          flex: variant === "panel" ? "1 1 auto" : void 0,
          overflow: "hidden",
    ...
    isActive && /* @__PURE__ */ jsx("div", { className: liveIndicatorClassName, children: /* @__PURE__ */ jsx("span", { className: isSpeaking ? "speaking" : "silent", children: isSpeaking ? "Speaking" : `Tracking ${Math.min(audioLevel * 2, 100)}%` }) })
  ] });
}
